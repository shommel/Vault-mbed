...
Messagetype=enum(
    ...
    MessageType_DevBoardInitialize=900,
    MessageType_DevBoardInitializeRes=901,
    MessageType_PrepareVault=910,
    MessageType_PrepareVaultResponse=911,
    MessageType_FinalizeVault=912,
    MessageType_FinalizeVaultResponse=913,
    MessageType_UnvaultRequest=920,
    MessageType_UnvaultResponse=921,
    MessageType_CheckTotalBalance=950,
    MessageType_TotalBalance=951,
    MessageType_CheckVaultBalance=952,
    MessageType_VaultBalance=953,
    MessageType_CheckUnvaultBalance=954,
    MessageType_UnvaultBalance=955,
    MessageType_SyncP2TSTs=990,
    MessageType_SyncRes=991,
)
